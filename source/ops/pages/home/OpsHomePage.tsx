        ...
        <div className="mx-auto flex flex-row px-8 py-6">
            ...
            <div className="flex flex-grow flex-col pr-6">
                ...
                <div className="flex flex-row justify-between gap-3">
                    <CardLink href="/ops/fulfillment" title="Orders" value={'+33 ($3,000)'} date="Today" />
                    <CardLink href="/ops/fulfillment" title="Active Users" value={'4,240'} date="Today" />
                    <CardLink href="/ops/fulfillment" title="New Accounts" value={'+410'} date="Today" />
                </div>

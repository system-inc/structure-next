...
import { PostReactionControl } from '@structure/source/modules/post/reactions/components/controls/PostReactionControl';
import { PostShareControl } from '@structure/source/modules/post/components/controls/PostShareControl';
import { PostReportControl } from '@structure/source/modules/post/report/components/controls/PostReportControl';
    ...
    return (
        <div className={mergeClassNames('flex items-center justify-between space-x-2 text-sm', properties.className)}>
            ...
            <div className="flex items-center space-x-2">
                ...
                {/* Time Ago */}
                <div className="content--2 dark:content--2">
                    <TimeAgo

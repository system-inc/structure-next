...
// Dependencies - API
import { usePostReportCreateRequest } from '@structure/source/modules/post/report/hooks/usePostReportCreateRequest';
...
export function PostCommentReportDialog(properties: PostCommentReportDialogProperties) {
    // State
    ...
    // Hooks
    const postReportCreateRequest = usePostReportCreateRequest();

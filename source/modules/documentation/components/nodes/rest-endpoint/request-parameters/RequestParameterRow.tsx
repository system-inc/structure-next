...
import { ObjectRequestParameterRow } from '@structure/source/modules/documentation/components/nodes/rest-endpoint/request-parameters/ObjectRequestParameterRow';
import { ArrayRequestParameterRow } from '@structure/source/modules/documentation/components/nodes/rest-endpoint/request-parameters/ArrayRequestParameterRow';
...
export function RequestParameterRow(properties: RequestParameterRowProperties) {
    ...
    return (
        <>
            <tr className="border border--0" onClick={handleRowClick}>

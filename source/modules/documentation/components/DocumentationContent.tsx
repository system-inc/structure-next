...
import { RestEndpointNodeContent } from '@structure/source/modules/documentation/components/nodes/rest-endpoint/RestEndpointNodeContent';
...
export function DocumentationContent(properties: DocumentationContentProperties) {
    ...
    return <div className="px-8 pt-6 pb-28">{content}</div>;
}

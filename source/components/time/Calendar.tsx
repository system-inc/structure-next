    ...
    return (
        <ReactDayPicker
            ...
            classNames={{
                ...
                weekdays: 'flex',
                weekday: 'content--b rounded-md w-8 font-normal text-[0.8rem]',
                ...
                range_middle:
                    'background--b [&_button]:!background--b [&_button]:!content--a [&_button]:!rounded-none [&_button]:hover:!background--b',
                selected: '',
                today: '[&_button]:background--b [&_button]:content--a [&_button]:rounded-md',

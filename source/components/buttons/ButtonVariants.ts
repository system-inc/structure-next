...
export const ButtonVariants = {
    ...
    default: mergeClassNames(
        ...
        `border`,
        // Light
        `text-dark-2 border--3 background--2`,
        // Dark
    ...
    light: mergeClassNames(
        ...
        `dark:bg-light-2 dark:text-dark text-dark hover:bg-light dark:hover:bg-light border background--2`,
        // Disabled states

...
export const MenuSearch = React.memo(
    function MenuSearch({ searchInputTextReference, onSearch, ...inputTextProperties }: MenuSearchProperties) {
        // Functions
    ...
    function arePropertiesEqual(previousProperties, nextProperties) {
        // Only re-render if searchInputTextReference changes
        // We ignore onSearch function reference since it's recreated every render
        return previousProperties.searchInputTextReference === nextProperties.searchInputTextReference;
    },
);

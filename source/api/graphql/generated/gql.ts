...
const documents: Documents = {
    ...
    '\n            query PostTopic($slug: String!, $path: String, $type: String!, $pagination: PaginationInput!) {\n                postTopic(slug: $slug, path: $path, type: $type, pagination: $pagination) {\n                    topic {\n                        id\n                        title\n                        slug\n                        description\n                        postCount\n                        createdAt\n                    }\n                    subTopics {\n                        id\n                        title\n                        slug\n                        description\n                        postCount\n                        createdAt\n                    }\n                    pagedPosts {\n                        items {\n                            id\n                            identifier\n                            slug\n                            status\n                            title\n                            description\n                            content\n                            metadata\n                            updatedAt\n                            createdAt\n                        }\n                        pagination {\n                            itemIndex\n                            itemIndexForPreviousPage\n                            itemIndexForNextPage\n                            itemsPerPage\n                            itemsTotal\n                            pagesTotal\n                            page\n                        }\n                    }\n                }\n            }\n        ':
        types.PostTopicDocument,
    '\n            mutation PostTopicUpdate($input: PostTopicUpdateInput!) {\n                postTopicUpdate(input: $input) {\n                    id\n                    title\n                    slug\n                    description\n                    postCount\n                    createdAt\n                }\n            }\n        ':
        types.PostTopicUpdateDocument,
    '\n            query PostTopics($ids: [String!]) {\n                postTopics(ids: $ids) {\n                    id\n                    title\n                    slug\n                    description\n                    postCount\n                    createdAt\n                }\n            }\n        ':
        types.PostTopicsDocument,
    '\n            query SupportAllSupportProfiles {\n                supportAllSupportProfiles {\n                    username\n                    displayName\n                    images {\n                        type\n                        url\n                        variant\n                    }\n                }\n            }\n        ':
...
export function graphql(
    source: '\n            query PostDetailed($id: String, $slug: String, $identifier: String) {\n                post(id: $id, slug: $slug, identifier: $identifier) {\n                    id\n                    identifier\n                    slug\n                    status\n                    title\n                    createdByProfileId\n                    createdByProfile {\n                        displayName\n                        username\n                        images {\n                            url\n                            type\n                            variant\n                        }\n                    }\n                    topics {\n                        id\n                        title\n                        slug\n                    }\n                    content\n                    reactions {\n                        content\n                        count\n                        reacted\n                    }\n                    upvoteCount\n                    downvoteCount\n                    voteType\n                    reportedCount\n                    reportStatus\n                    metadata\n                    latestRevisionId\n                    updatedAt\n                    createdAt\n                }\n            }\n        ',
): typeof import('./graphql').PostDetailedDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
...
export function graphql(
    source: '\n            query PostsDetailed($pagination: PaginationInput!) {\n                posts(pagination: $pagination) {\n                    pagination {\n                        itemIndex\n                        itemIndexForPreviousPage\n                        itemIndexForNextPage\n                        itemsPerPage\n                        itemsTotal\n                        pagesTotal\n                        page\n                    }\n                    items {\n                        id\n                        identifier\n                        slug\n                        status\n                        title\n                        createdByProfileId\n                        createdByProfile {\n                            displayName\n                            username\n                            images {\n                                url\n                                type\n                                variant\n                            }\n                        }\n                        content\n                        reactions {\n                            content\n                            count\n                            reacted\n                        }\n                        upvoteCount\n                        downvoteCount\n                        voteType\n                        reportedCount\n                        reportStatus\n                        metadata\n                        latestRevisionId\n                        updatedAt\n                        createdAt\n                    }\n                }\n            }\n        ',
): typeof import('./graphql').PostsDetailedDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
...
export function graphql(
    source: '\n            query PostTopic($slug: String!, $path: String, $type: String!, $pagination: PaginationInput!) {\n                postTopic(slug: $slug, path: $path, type: $type, pagination: $pagination) {\n                    topic {\n                        id\n                        title\n                        slug\n                        description\n                        postCount\n                        createdAt\n                    }\n                    subTopics {\n                        id\n                        title\n                        slug\n                        description\n                        postCount\n                        createdAt\n                    }\n                    pagedPosts {\n                        items {\n                            id\n                            identifier\n                            slug\n                            status\n                            title\n                            description\n                            content\n                            metadata\n                            updatedAt\n                            createdAt\n                        }\n                        pagination {\n                            itemIndex\n                            itemIndexForPreviousPage\n                            itemIndexForNextPage\n                            itemsPerPage\n                            itemsTotal\n                            pagesTotal\n                            page\n                        }\n                    }\n                }\n            }\n        ',
): typeof import('./graphql').PostTopicDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
...
export function graphql(
    source: '\n            query PostTopics($ids: [String!]) {\n                postTopics(ids: $ids) {\n                    id\n                    title\n                    slug\n                    description\n                    postCount\n                    createdAt\n                }\n            }\n        ',
): typeof import('./graphql').PostTopicsDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
...
export function graphql(
    source: '\n            query SupportTickets($pagination: PaginationInput!) {\n                supportTickets(pagination: $pagination) {\n                    items {\n                        identifier\n                        title\n                        status\n                        userEmailAddress\n                        comments {\n                            id\n                            source\n                            visibility\n                            content\n                            contentType\n                            createdAt\n                            attachments {\n                                type\n                                url\n                                variant\n                            }\n                        }\n                    }\n                }\n            }\n        ',
): typeof import('./graphql').SupportTicketsDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
